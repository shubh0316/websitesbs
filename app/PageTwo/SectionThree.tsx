        ...
        <div className="md:col-span-1 col-span-2 md:order-first order-last">
               ...
               <div className="grid md:col-span-1 col-span-2">
                ...
                <div className="flex flex-col gap-4 font-sans">
                    <div className="font-bold">BLOCKCHAIN DEVELOPMENT</div>
                    <span className='text-md text-slate-700 font-normal'>Cryptocurrency (Digital Currency), smart contracts, peer to peer, Proof of Work and cryptography technology</span>
                    <span className="text-md text-slate-700 font-normal">
                    The Blockchain consists of individual behavior specifications, a large set of rules that are programmed into it. Those specifications are called protocols. The implementation of specific protocols essentially made Blockchain what it is — a distributed, peer-to-peer and secured information database.
                    </span>
                    <span className="text-md text-slate-700 font-normal">
