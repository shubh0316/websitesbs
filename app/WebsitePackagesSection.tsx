...
export default function WebsitePackagesSection() {
  return (
    <div className="flex  mx-auto flex-col  gap-4 justify-content">
      ...
      <div className="text-slate-600 text-center text-lg font-sans">We are providing following best website package.</div>
      ...
      <div className="rounded-xl transition duration-500 ease-in-out mx-auto  hover:scale-110 hover:ease-in-out shadow-lg flex flex-col md:gap-4  px-8 md:px-8 py-6">
          ...
          <div className="flex flex-col md:text-md text-sm space-y-4">
            ...
            <div className="flex flex-row justify-content items-baseline gap-2 md:gap-4">
              ...
              <span>Up to 10 Photos Integrated</span>
            </div>
            <div className="flex flex-row justify-content items-baseline gap-2 md:gap-4">
              <span className="">
                <svg
