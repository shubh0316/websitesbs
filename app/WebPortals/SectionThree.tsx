...
const SectionThree = () => {
  return (
    <div className="bg-slate-100 flex flex-col items-center justify-center py-10 h-full">
      <div className="text-2xl font-bold mb-3">OUR FEATURES</div>
      <div className="text-md text-slate-600 font-normal leading-tight mb-8">
